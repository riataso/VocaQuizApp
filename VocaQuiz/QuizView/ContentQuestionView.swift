...
struct ContentQuestionView: View {
    ...
    var body: some View {
            VStack(spacing: 30) {
                if let quizItem = viewModel.quizWord {
                    ...
                    Button {
                        viewModel.userAnswerCorreckCheck(userAnswer: viewModel.userAnswer, quizType: .wordToAnswer)
